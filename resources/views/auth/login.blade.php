        ...
        <form action="/login" method="POST">
            ...
            <div class="form-floating my-2">
                <x-common.form.form-input class="border rounded-0" type="email" class="form-control" id="email"
                    aria-describedby="emailHelp" placeholder="name@example.com" name="email" :value="old('email')"></x-common.form.form-input>
                <x-common.form.form-label for="email">Email address or Username</x-common.form.form-label>
            </div>

            <x-common.form.form-error field="email"></x-common.form.form-error></div>
